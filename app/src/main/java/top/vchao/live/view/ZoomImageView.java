...
/**
 * @ Create_time: 2018/4/2 on 8:46.
 * @ description： 可缩放的 imageView
...
public class ZoomImageView extends android.support.v7.widget.AppCompatImageView implements ViewTreeObserver.OnGlobalLayoutListener
    ...
    protected void onAttachedToWindow() {
        ...
        LogUtils.e("注册了OnGlobalLayoutListener");
    ...
    protected void onDetachedFromWindow() {
        ...
        LogUtils.e("反注册了OnGlobalLayoutListener");
        getViewTreeObserver().removeOnGlobalLayoutListener(this);
    }

    @Override
    public void onGlobalLayout() {
        LogUtils.e("执行了onGlobalLayout| NULL:" + (getDrawable() == null));
        ...
        if (!isInit) {
            ...
            if (screenWeight >= imageWeight) {
                ...
                if (imageH > height && imageW > width) {
                    ...
                    LogUtils.e("max scale:" + scale);
                }

                if (imageH < height && imageW < width) {
                    scale = Math.min(width * 1.0f / imageW, height * 1.0f / imageH);
                    LogUtils.e("min scale:" + scale);
                }
